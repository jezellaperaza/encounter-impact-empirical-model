## Abundance per bin probabilities
## Day versus night
## Transects two through four
## August 2022
...
day_acoustic_data_30 <- acoustic_data %>% filter(Layer_depth_max <= 30)
day_acoustic_data_60 <- acoustic_data %>% filter(Layer_depth_max <= 60)
...
hist(day_two_four_30_prob, breaks = 100)
...
hist(day_two_four_60_prob, breaks = 100)
...
night_acoustic_data_30 <- acoustic_data %>% filter(Layer_depth_max <= 30)
night_acoustic_data_60 <- acoustic_data %>% filter(Layer_depth_max <= 60)
...
hist(night_two_four_30_prob, breaks = 100)
...
hist(night_two_four_60_prob, breaks = 100)
